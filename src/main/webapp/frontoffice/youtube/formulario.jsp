...
<%@include file="../../includes/navbar.jsp"%>
	...
	<h1>Formulario modificar videos propios</h1>
	...
	<div class="row">
		<div class="col">
			...
			<form action="frontoffice/videos" method="post" class="mb-2">
				...
				<input type="hidden" name="op" value="<%=VideoFrontofficeController.OP_GUARDAR%>">
			
				<div class="form-group">	
					<input type="hidden" name="id" value="${video.id}" readonly class="form-control">
				</div>
			...
			<c:if test="${video.id != -1}">
				...
				<button type="button" class="btn btn-outline-danger btn-block" data-toggle="modal" data-target="#eliminar${video.id}">
				  Eliminar
				</button>
		
				<!-- Modal -->
				<div class="modal fade" id="eliminar${video.id}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
